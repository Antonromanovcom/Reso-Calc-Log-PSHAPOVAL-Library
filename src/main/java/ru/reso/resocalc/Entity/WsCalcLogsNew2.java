...
public class WsCalcLogsNew2 implements Serializable, CalcEntity {
    ...
    public WsCalcLogsNew2() {

    }

    public WsCalcLogsNew2(Long calcid) {
        this.calcid = calcid;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof WsCalcLogsNew2)) {
            return false;
        }
        WsCalcLogsNew2 other = (WsCalcLogsNew2) object;
        return !((this.calcid == null && other.calcid != null) || (this.calcid != null && !this.calcid.equals(other.calcid)));
    }

    @Override
    public String toString() {
        return "ru.reso.common.logs.WsCalcLogsNew2[ calcid=" + calcid + " ]";
    }
