    ...
    public WsPremium webRowSet2Entity(WebRowSet rs) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                bonuses.addToHash(String.valueOf(rs.getInt("PREMIUMTYPE"))+"@" + String.valueOf(rs.getDouble("DEDUCTIBLE_SUM")), String.valueOf(rs.getDouble("DEDUCTIBLE_SUM")) + "-" + String.valueOf(rs.getDouble("PREMIUM_SUM")));
